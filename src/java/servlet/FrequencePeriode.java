 ...
 * @author sacha
 */
public class FrequencePeriode extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            List<EnrEntity> donnees = dao.frequenceFQPeriode(debut, fin, Integer.parseInt(session.getAttribute("id").toString()));
            ...
            Logger.getLogger(FrequencePeriode.class.getName()).log(Level.SEVERE, null, ex);
        }
    }
